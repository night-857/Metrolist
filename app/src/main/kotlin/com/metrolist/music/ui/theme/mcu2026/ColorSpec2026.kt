...
import com.materialkolor.scheme.ColorSpec
...
open class ColorSpec2026 : ColorSpec2025() {
    ...
    get() {
      val color2026 =
        DynamicColor(
          ...
          tone = { if (it.isDark) 4.0 else 98.0 },
          isBackground = true,
        )
      return color2026
    }
    ...
    get() {
      val color2026 =
        DynamicColor(
          name = "surface_dim",
          palette = { it.neutralPalette },
          tone = { if (it.isDark) 4.0 else 87.0 },
          isBackground = true,
          chromaMultiplier = { if (it.isDark) 1.0 else 1.7 },
        )
      return color2026
    }
    ...
    get() {
      val color2026 =
        DynamicColor(
          name = "surface_bright",
          palette = { it.neutralPalette },
          tone = { if (it.isDark) 18.0 else 98.0 },
          isBackground = true,
          chromaMultiplier = { if (it.isDark) 1.7 else 1.0 },
        )
      return color2026
    }
    ...
    get() {
      val color2026 =
        DynamicColor(
          ...
          palette = { it.neutralPalette },
          tone = { if (it.isDark) 0.0 else 100.0 },
          isBackground = true,
        )
      return color2026
    }
    ...
    get() {
      val color2026 =
        DynamicColor(
          ...
          palette = { it.neutralPalette },
          tone = { if (it.isDark) 6.0 else 96.0 },
          isBackground = true,
    ...
    get() {
      val color2026 =
        DynamicColor(
          ...
          palette = { it.neutralPalette },
          tone = { if (it.isDark) 9.0 else 94.0 },
          isBackground = true,
    ...
    get() {
      val color2026 =
        DynamicColor(
          ...
          palette = { it.neutralPalette },
          tone = { if (it.isDark) 12.0 else 92.0 },
          isBackground = true,
    ...
    get() {
      val color2026 =
        DynamicColor(
          ...
          palette = { it.neutralPalette },
          tone = { if (it.isDark) 15.0 else 90.0 },
          isBackground = true,
  ...
  private fun highestSurface(s: DynamicScheme): DynamicColor {
    return if (s.isDark) ColorSpec2025().surfaceContainerHighest else ColorSpec2025().surface
  }
}
